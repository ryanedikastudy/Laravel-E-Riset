        ...
        <div class="border border-gray-200 rounded-md shadow-sm">
            ...
            <div class="p-8">
                <p class="text-sm text-gray-500">
                    Risetmu sudah dikirimkan kepada tim admin untuk melalui proses approval. Lakukan pemeriksaan secara
                    berkala pada akunmu untuk melihat pembaruan status approval risetmu. Terima kasih atas kontribusi
                    Anda!
                </p>
            </div>
        </div>
