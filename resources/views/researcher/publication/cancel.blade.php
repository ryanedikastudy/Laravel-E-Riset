        ...
        <div class="border border-gray-200 rounded-md shadow-sm">
            ...
            <div class="p-8">
                <p class="text-sm text-gray-500">
                    {{ __('Publikasimu berhasil dibatalkan, untuk membuat publikasi baru kamu dapat melakukan proses upload kembali, periksa informasi yang diinputkan sebelum melakukan konfirmasi. Jika sudah yakin, klik ”Simpan".') }}
                </p>
            </div>
        </div>
